...
export const VK_LOGIN_REF = "https://oauth.vk.com/authorize?client_id=6656636&display=page&redirect_uri="+ROOT+"/login/vk&scope=email&response_type=code&v=5.80";
